...
namespace Bankify {
    ...
    public partial class Bank_dbDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientAccountDataTable : global::System.Data.TypedTableBase<ClientAccountRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ClientAccountRow AddClientAccountRow(string first_name, string last_name, int age, string country, string phone_number, string email, System.DateTime birthday, int login_id) {
...
namespace Bankify.Bank_dbDataSetTableAdapters {
    ...
    public partial class ClientAccountTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[ClientAccount] ([first_name], [last_name], [age], [country], [phone_number], [email], [birthday], [login_id]) VALUES (@first_name, @last_name, @age, @country, @phone_number, @email, @birthday, @login_id);
SELECT client_id, first_name, last_name, age, country, phone_number, email, birthday, login_id FROM ClientAccount WHERE (client_id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[ClientAccount] SET [first_name] = @first_name, [last_name] = @last_name, [age] = @age, [country] = @country, [phone_number] = @phone_number, [email] = @email, [birthday] = @birthday, [login_id] = @login_id WHERE (([client_id] = @Original_client_id) AND ([first_name] = @Original_first_name) AND ([last_name] = @Original_last_name) AND ([age] = @Original_age) AND ([country] = @Original_country) AND ([phone_number] = @Original_phone_number) AND ([email] = @Original_email) AND ([birthday] = @Original_birthday) AND ([login_id] = @Original_login_id));
SELECT client_id, first_name, last_name, age, country, phone_number, email, birthday, login_id FROM ClientAccount WHERE (client_id = @client_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT client_id, first_name, last_name, age, country, phone_number, email, birth" +
                "day, login_id FROM dbo.ClientAccount";
        ...
        public virtual int Delete(int Original_client_id, string Original_first_name, string Original_last_name, int Original_age, string Original_country, string Original_phone_number, string Original_email, System.DateTime Original_birthday, int Original_login_id) {
        ...
        public virtual int Insert(string first_name, string last_name, int age, string country, string phone_number, string email, System.DateTime birthday, int login_id) {
            if ((first_name == null)) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[16].Value = ((int)(Original_login_id));
        ...
        public virtual int Update(
                    ...
                    System.DateTime Original_birthday, 
                    int Original_login_id) {
            return this.Update(first_name, last_name, age, country, phone_number, email, birthday, login_id, Original_client_id, Original_first_name, Original_last_name, Original_age, Original_country, Original_phone_number, Original_email, Original_birthday, Original_login_id, Original_client_id);
        }
    }
